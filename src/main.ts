...
const ANDROID_APK = 'https://github.com/B-Divyesh/sf-android-select-speak-canvas/releases/download/v1.0.1/tapread-canvas-1.0.1.apk';
const ANDROID_APK_NOTE = import.meta.env.VITE_NATIVE_PACKAGE === '1'
  ? 'v1.0.1 · Check the download page for its SHA-256'
  : 'v1.0.1 · SHA-256 4522f04af9dfbd5aa1baa4d122cb290e99911a48456acf441a2c122f169f2495';
